    ...
    <div class="hot-tj">
        ...
        <ul class="hot-list clearfix">
        	...
        	<li class="item asynPriceBox">
        		...
        		<p class="name"><a href="{{url('Page/goodsDetail',[$v->id])}}" title=" 联想(lenovo) 小新潮5000 15.6英寸轻薄笔记本电脑">{{$v->goods_name}}</a></p>
...
<div class="shangp_lieb_jvz">
		        ...
		        <div class="sl-value">
		          	<div class="sl-v-list">
			            <ul class="J_valueList">
			                <li>
			                  	<a href="{{url("Page/pageDetail/$id")}}?k={{$brand}}_0"  rel='nofollow'>不限</a>
			                </li>
							<li>
			                  	<a href="{{url("Page/pageDetail/$id")}}?k={{$brand}}_1"  rel='nofollow'>0-100</a>
			                </li>
			                <li>
			                  	<a href="{{url("Page/pageDetail/$id")}}?k={{$brand}}_2"  rel='nofollow'>100-200</a>
			                </li>
			                <li>
			                  	<a href="{{url("Page/pageDetail/$id")}}?k={{$brand}}_3"  rel='nofollow'>200-300</a>
			                </li>
							<li>
			                  	<a href="{{url("Page/pageDetail/$id")}}?k={{$brand}}_4"  rel='nofollow'>300-400</a>
			                </li>
							<li>
			                  	<a href="{{url("Page/pageDetail/$id")}}?k={{$brand}}_5"  rel='nofollow'>400-500</a>
			                </li>
							<li>
			                  	<a href="{{url("Page/pageDetail/$id")}}?k={{$brand}}_6"  rel='nofollow'>500以上</a>
			                </li>
			            </ul>
		            </div>
	            </div>
            ...
            <div class="sl-wrap">
		        ...
		        <div class="sl-value">
		          	<div class="sl-v-list">
			            <ul class="J_valueList">
			                <li>
			                  	<a href="{{url("Page/pageDetail/$id")}}?k=0_{{$price}}"  rel='nofollow'>不限</a>
			                </li> <li>
			                  	<a href="{{url("Page/pageDetail/$id")}}?k=1_{{$price}}"  rel='nofollow'>太平鸟</a>
			                </li>
			                <li>
			                  	<a href="{{url("Page/pageDetail/$id")}}?k=2_{{$price}}"  rel='nofollow'>波司登</a>
			                </li>
			                <li>
			                  	<a href="{{url("Page/pageDetail/$id")}}?k=3_{{$price}}"  rel='nofollow'>哥弟</a>
			                </li>
			                <li>
			                  	<a href="{{url("Page/pageDetail/$id")}}?k=4_{{$price}}"  rel='nofollow'>恒源祥</a>
			                </li>
			                <li>
			                  	<a href="{{url("Page/pageDetail/$id")}}?k=5_{{$price}}"  rel='nofollow'>伊芙丽</a>
			                </li>
							<li>
			                  	<a href="{{url("Page/pageDetail/$id")}}?k=6_{{$price}}"  rel='nofollow'>阿迪达斯</a>
			                </li>
							<li>
			                  	<a href="{{url("Page/pageDetail/$id")}}?k=7_{{$price}}"  rel='nofollow'>李宁</a>
			                </li>
			            </ul>
		            </div>
	            </div>
	...
	<script>
		{{--$('.sl-v-list>a').eq({{$brand}}).addClass('sel');--}}
		$('.sl-v-list>a').eq({{$price}}).addClass('sel');
	</script>
	<!--测试****************************************-->
		<script type="text/javascript">
		function xians()
