...
<div class="formbody">
    <div id="usual1" class="usual">
        <div id="tab1" class="tabson">
            <form action="{{url('Admins/EditAction')}}" method="post" id="form1" onsubmit="fun()">
                {{csrf_field()}}
              <input type="hidden" value="{{$row->id}}" name="id">
                ...
                <ul class="forminfo">
                    ...
                    <li>
                        ...
                        <input name="admin_pass" type="text" class="dfinput" placeholder="请填写管理员名称"  style="width:518px;" value="{{$row->admin_pass}}"/>
                    </li>
