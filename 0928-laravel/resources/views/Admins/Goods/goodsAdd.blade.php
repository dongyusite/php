...
<div class="formbody">
    <div id="usual1" class="usual">
        <div id="tab1" class="tabson">
            <form action="{{url('Goods/goodsAddAction')}}" method="post" enctype="multipart/form-data">
                <ul class="forminfo">
                    <li>
                    ...
                    <li>
                        ...
                        <input name="goods_pic" onchange="showPic()" id="goods_pic" type="file" class="dfinput">

                    </li>
                    <img src="" id = "img1" alt="" style="width: 300px;height: 300px">
                    <li>
...
<script>
    var pic = '';
    function showPic(){
        pic = document.getElementsByTagName('input')[3].files[0];
        img_pic = window.URL.createObjectURL(pic);
        document.getElementById('img1').src = img_pic;
    }
</script>