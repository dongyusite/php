		...
		<div class="login_form">
			<div class="login_tab">
				...
				<div class="dengl_erwm">
					<a href="#"><img src="{{asset('images/er_wm.png')}}"></a>
					<div class="tanc_erwm_kuang">
						<img src="{{asset('images/mb_wangid.png')}}">
			...
			<form action="{{url('Page/loginAction')}}" method="post">
				<input type="hidden" value="{{$returnUrl}}" name="returnUrl">
				{{csrf_field()}}
			<div class="kengl_kuang">
				<div class="txt_kuang">
					<input type="text" class="itxt" name="admin_name" id="admin_name"  placeholder="邮箱/用户名/已验证手机">
					<input type="text" class="itxt"  name="admin_pass"  id="admin_pass" placeholder="密码">
				</div>
				<div class="remember">
					<div class="fl">
						<input type="checkbox" >
