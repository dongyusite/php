...
<div class="dianp_logo_beij">
	...
	<div class="dianp_logo_img">
		<img src="{{asset("/upload/$v->brand_pic")}}" style="width: 1100px;height: 150px">
	</div>
	@endforeach
	...
	<div class="lib_ds">
		...
		<div class="sdu_you">
			<div class="xians_fangs">
				<div class="dsfd_d">
					<span>显示：</span>
					<span><a href="#" class="losd_14 da_15 df_15"></a></span>
					<span><a href="#" class="losd_14 ds_15"></a></span>
				</div>
				<div class="dsfd_d">
					<span>分类：</span>
					<span class="dgf_zy"><a href="#" class="lod_ds">品牌</a><em class="df"></em></span>
					<span class="dgf_zy"><a href="#" class="lod_ds">价格</a><em></em></span>
					<span class="dgf_zy"><a href="#" class="lod_ds">销量</a><em></em></span>
					<span class="dgf_zy"><a href="#" class="lod_ds">评价</a><em></em></span>
					<span class="dgf_zy"><a href="#" class="lod_ds">性价比</a><em></em></span>
				</div>
